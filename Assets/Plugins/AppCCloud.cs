...
public class AppCCloud
{
	...
	{
		InDevelopment, InReview, ReadyForSale, 
	}
	...
	public ReleaseStatus getReleaseStatus() { return ReleaseStatus.ReadyForSale; }
	...
	[DllImport("__Internal")]
	private static extern int _getReleaseStatus();
	[DllImport("__Internal")]
	...
	[DllImport("__Internal")]
	private static extern int _showingAppCWebView();
	[DllImport("__Internal")]
	...
	[DllImport("__Internal")]
	private static extern int _rewardShowListPoint();
	[DllImport("__Internal")]
	private static extern int _rewardShowListService(string service_id);
	[DllImport("__Internal")]
	private static extern int _rewardIsService(string service_id);
	[DllImport("__Internal")]
	private static extern void _rewardClearService(string service_id);
	...
	public ReleaseStatus getReleaseStatus() {
		int status = _getReleaseStatus();
		switch(status) {
		case 0 : return ReleaseStatus.InDevelopment;
		case 1 : return ReleaseStatus.InReview;
		case 2 : return ReleaseStatus.ReadyForSale;
		}
		return ReleaseStatus.ReadyForSale;
	}
	...
	public class _Reward {
		...
		public void OpenRewardPointView()
		{
			_rewardShowListPoint();
		}
		public void OpenRewardServiceView(string serviceId)
		{
			_rewardShowListService(serviceId);
		}
		public bool IsRewardService(string serviceId)
		{
			return (_rewardIsService(serviceId) != 0);
		}
		public void ClearRewardService(string serviceId)
		{
			_rewardClearService(serviceId);
		}
