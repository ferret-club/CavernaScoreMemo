...
extern "C" BOOL _setupAppCWithMediaKey(const char* mk,
    ...
    if (opt_reward) opt |= APPC_CLOUD_REWARD;
...
extern "C" int _isForegroundAd() {
	return (int)([appCCloud showingWebView] || [appCCloud showingAd] || [appCCloud showingCutin]);
}

//////////////////////////////////////////////////
// get release status
extern "C" int _getReleaseStatus() {
...
extern "C" int _showingAppCWebView() {
	return (int)[appCCloud showingWebView];
}
...
//////////////////////////////////////////////////
// for appCCloud Reward
extern "C" int _rewardShowListPoint() {
    return (int)[appCCloud rewardShowListPoint];
}

extern "C" int _rewardShowListService(const char* service_id) {
    return (int)[appCCloud rewardShowListServiceWithId:
                 [NSString stringWithUTF8String:service_id]];
}

extern "C" int _rewardIsService(const char* service_id) {
    return (int)[arrServiceId containsObject:
                 [NSString stringWithUTF8String:service_id]];
}

extern "C" void _rewardClearService(const char* service_id) {
    [arrServiceId removeObject:[NSString stringWithUTF8String:service_id]];
}
